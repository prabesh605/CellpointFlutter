...
class SliderSecond extends StatefulWidget {
  const SliderSecond({
    super.key,
  ...
  @override
  State<SliderSecond> createState() => _SliderSecondState();
}

class _SliderSecondState extends State<SliderSecond> {
